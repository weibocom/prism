package com.weibo.api.platform.prism.storm.topology;
...
import com.weibo.api.platform.prism.storm.scanner.ComponentScanner;
import com.weibo.api.platform.prism.storm.scanner.ScannerFactory;
import com.weibo.api.platform.prism.storm.spout.ScribeSpout;
...
public class ScribeConsumerTopology {
	...
	public static void main(String[] args) throws Exception {
		if(args == null || args.length < 3){
			LOG.error("Start Usage: java $class $zkStr $prism.scribe.server.path $prism.socket.server.path");
			System.exit(-1);
		}
